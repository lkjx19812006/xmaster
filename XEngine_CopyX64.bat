...
copy /y "%XEngine_Lib64%\XEngine_AVCoder\XEngine_VideoCoder.dll" "./"
copy /y "%XEngine_Lib64%\XEngine_AVCoder\XEngine_AudioCoder.dll" "./"
copy /y "%XEngine_Lib64%\XEngine_AVCoder\XEngine_AVCollect.dll" "./"
copy /y "%XEngine_Lib64%\XEngine_AVCoder\XEngine_AVHelp.dll" "./"
copy /y "%XEngine_Lib64%\XEngine_AVCoder\XEngine_AVPacket.dll" "./"
